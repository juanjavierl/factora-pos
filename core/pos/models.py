...
class TransactionSummary(models.Model):
    receipt_number = models.CharField(max_length=50, null=True, blank=True, verbose_name='Número de comprobante')
    receipt_number_full = models.CharField(max_length=50, null=True, blank=True, verbose_name='Número completo de comprobante')
    ...
    tax = models.DecimalField(max_digits=9, decimal_places=4, default=0.00, verbose_name='IVA')
    total_tax = models.DecimalField(max_digits=9, decimal_places=4, default=0.00, verbose_name='Total de IVA')
    ...
    def save(self, force_insert=False, force_update=False, using=None,
             update_fields=None):
        if not self.pk and isinstance(self, (Invoice, CreditNote)):
